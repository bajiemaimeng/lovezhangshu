...
//e.setItem=function(){}
    ...
    return {
        init: function () {
            ...
            e.run(function () {
                ...
                e.canvas.fillStyle("#FFF").fillScreen().drawImage("logo", i - 480 >> 1, u).drawImage("btns1", 0, 99, 480, 7, i - 480 >> 1, u + 140, 480, 7).drawImage("btns1", 0, 99, 480, 7, i - 480 >> 1, u + 555, 480, 7), e.buttonLayout.released("difficulty1") ? (l.moduleName = "我的成绩^_^", hideAd(), c(2)) : e.buttonLayout.released("difficulty2") ? (l.moduleName = "噩梦模式", c(3)) : e.buttonLayout.released("difficulty3") ? (l.moduleName = "地狱模式", c(4)) : e.buttonLayout.released("difficulty4") ? (l.moduleName = "炼狱模式", c(5)) : e.buttonLayout.released("rank") && dp_Ranking()
            }).zone(function () {
            ...
            var l = {
                ...
                if (l.time > 10000) {
                    dp_share(l.time);
                    alert("继续加油追我 这样就不用骑摩拜减肥了" + l.time / 1000 + "秒！")
                }
                ;
                e.buttonLayout.clear().create({
                    id: "return",
    ...
    e.init(window.innerWidth, window.innerHeight).pushImage([{id: "logo", src: "WechatIMG63.png"}, {
        id: "btns1",
        src: "gdyx.png"
    }], function (e, t, n) {
